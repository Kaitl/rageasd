...
function draw() {
    ...
    if (drawn_sketch==randomsketch) {
        answer_holder="set"
        score=score+1
        document.getElementById("spammy").innerHTML="Score: "+score
    }
}

function check_sketch(){
    timer_counter=timer_counter+1
    document.getElementById("Timmy").innerHTML="Timer: "+timer_counter
...
function updateCanvas() {
    ...
    randomsketch=quick_draw_data_set[random_number]
    document.getElementById("sree").innerHTML="Sketch to be drawn: "+randomsketch
